                ...
                {!data ? (
                  ...
                  data.map((item, idx) => (
                    <button
                      ...
                      className={`w-full group p-3 rounded-2xl transition-all text-left border relative overflow-hidden ${
                        selectedMeasurement === idx 
          ...
          {!data ? (
            <div className="flex-1 flex flex-col items-center justify-center p-10 relative">
               ...
               <div 
                 ...
                 className={`w-full max-w-xl p-16 rounded-[60px] border border-white/10 transition-all cursor-pointer group flex flex-col items-center text-center gap-10 backdrop-blur-xl bg-white/[0.02] shadow-2xl ${
                   isDragging ? 'border-emerald-400 bg-emerald-500/5 scale-[1.03]' : 'hover:bg-white/[0.04] hover:border-white/20'
                 }`}
